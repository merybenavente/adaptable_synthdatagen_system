...
- gathering the right context and constraints,
...
Outside this generation loop, the system includes an **evaluation** module (toy implementation for now) that tests the generated datasets on downstream tasks—training small models on the synthetic data to measure their real-world utility and feeding those results back as additional signals for the bandit.
